      ...
      CASE <item>-type.
        ...
        WHEN content_type-resource_link.
          ...
          IF <item>-res_icons IS NOT INITIAL.
            ...
            LOOP AT <item>-res_icons ASSIGNING FIELD-SYMBOL(<rl_icon>).
              DATA(rl_icon_path) = |{ content_path }/icons/{ sy-tabix }|.
              ...
              IF <rl_icon>-sizes IS NOT INITIAL.
                ...
                LOOP AT <rl_icon>-sizes ASSIGNING FIELD-SYMBOL(<rl_icon_size>).
