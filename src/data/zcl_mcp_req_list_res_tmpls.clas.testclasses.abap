CLASS ltcl_mcp_req_list_res_tmpls DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
...
CLASS ltcl_mcp_req_list_res_tmpls IMPLEMENTATION.
  METHOD test_with_cursor.
    ...
    " When
    DATA req TYPE REF TO zcl_mcp_req_list_res_tmpls.
    req = NEW #( json ).
