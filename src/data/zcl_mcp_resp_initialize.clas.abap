...
CLASS zcl_mcp_resp_initialize IMPLEMENTATION.
  METHOD zif_mcp_internal~generate_json.
    ...
    DATA effective_protocol_version LIKE temp1.
      FIELD-SYMBOLS <icon> LIKE LINE OF int_implementation-icons.
    ...
    IF int_protocol_version IS NOT INITIAL.
      temp1 = int_protocol_version.
    ELSE.
      temp1 = zif_mcp_constants=>latest_protocol_version.
    ENDIF.
    
    effective_protocol_version = temp1.
    ...
    IF int_implementation-icons IS NOT INITIAL.
      ...
      LOOP AT int_implementation-icons ASSIGNING <icon>.
        
        icon_path = |serverInfo/icons/{ sy-tabix }|.
