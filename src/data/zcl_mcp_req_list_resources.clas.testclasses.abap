CLASS ltcl_mcp_req_list_resources DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.

  PRIVATE SECTION.
    METHODS test_with_cursor    FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS test_without_cursor FOR TESTING RAISING zcx_mcp_ajson_error.
ENDCLASS.

CLASS ltcl_mcp_req_list_resources IMPLEMENTATION.
  METHOD test_with_cursor.
    ...
    " When
    DATA req TYPE REF TO zcl_mcp_req_list_resources.
    req = NEW #( json ).
