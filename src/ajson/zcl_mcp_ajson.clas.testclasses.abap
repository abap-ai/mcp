...
CLASS lcl_nodes_helper DEFINITION FINAL.
  PUBLIC SECTION.
    ...
    DATA mt_nodes TYPE zif_mcp_ajson_types=>ty_nodes_tt.
    METHODS add
      IMPORTING
        iv_str TYPE string.
    METHODS clear.
    METHODS sorted
      RETURNING
        VALUE(rt_nodes) TYPE zif_mcp_ajson_types=>ty_nodes_ts.
...
CLASS ltcl_parser_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS setup.
    METHODS parse FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_keeping_order FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_string FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_number FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_float FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_boolean FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_false FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_null FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_date FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_bare_values FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_error FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_input_xstring FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_input_string FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_input_string_table FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_input_error FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS duplicate_key FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS non_json FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_keys_with_slash FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS parse_keys_with_tilde FOR TESTING RAISING zcx_mcp_ajson_error.
...
CLASS ltcl_parser_test IMPLEMENTATION.
  ...
  METHOD parse_bare_values.
    ...
    DATA lt_act TYPE zif_mcp_ajson_types=>ty_nodes_tt.
  ...
  METHOD parse_error.
    ...
    DATA lt_act TYPE zif_mcp_ajson_types=>ty_nodes_tt.
    DATA lx_err TYPE REF TO zcx_mcp_ajson_error.
    TRY.
        lt_act = mo_cut->parse( 'abc' ).
        cl_abap_unit_assert=>fail( 'Parsing of string w/o quotes must fail (spec)' ).
      CATCH zcx_mcp_ajson_error INTO lx_err.
  ...
  METHOD parse_keys_with_slash.

    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
    DATA lt_act TYPE zif_mcp_ajson_types=>ty_nodes_tt.
    DATA lv_json TYPE string.

    " JSON with key containing slash
    lv_json = '{"my/key": "value1", "normal": "value2"}'.

    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '                 |         |object |                        |  |2' ).
    lo_nodes_exp->add( '/                |my~1key  |str    |value1                  |  |0' ).
    lo_nodes_exp->add( '/                |normal   |str    |value2                  |  |0' ).

    lt_act = mo_cut->parse( lv_json ).
    cl_abap_unit_assert=>assert_equals(
      act = lt_act
  ...
  METHOD parse_keys_with_tilde.

    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
    DATA lt_act TYPE zif_mcp_ajson_types=>ty_nodes_tt.
    DATA lv_json TYPE string.

    " JSON with key containing tilde
    lv_json = '{"my~key": "value1", "my/other": "value2"}'.

    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '                 |         |object |                        |  |2' ).
    lo_nodes_exp->add( '/                |my~0key  |str    |value1                  |  |0' ).
    lo_nodes_exp->add( '/                |my~1other|str    |value2                  |  |0' ).
...
CLASS ltcl_serializer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS stringify_condensed FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS stringify_indented FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_index FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS item_order FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS simple_indented FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS empty_set FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS escape_string FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS empty FOR TESTING RAISING zcx_mcp_ajson_error.
...
CLASS ltcl_utils_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS validate_array_index FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS string_to_xstring_utf8 FOR TESTING.

ENDCLASS.

CLASS zcl_mcp_ajson DEFINITION LOCAL FRIENDS ltcl_utils_test.
...
CLASS ltcl_utils_test IMPLEMENTATION.
  ...
  METHOD split_path.
    ...
    DATA ls_exp TYPE zif_mcp_ajson_types=>ty_path_name.
...
CLASS ltcl_reader_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS get_value FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS get_node_type FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS exists FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS value_integer FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS value_number FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS value_boolean FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS value_string FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS members FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS slice FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_to_string_table FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS get_date FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS get_timestamp FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS get_with_slash_key FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS exists_with_slash_key FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS members_unescaped FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS get_nested_escaped FOR TESTING RAISING zcx_mcp_ajson_error.

ENDCLASS.

CLASS zcl_mcp_ajson DEFINITION LOCAL FRIENDS ltcl_reader_test.
...
CLASS ltcl_reader_test IMPLEMENTATION.
  ...
  METHOD slice.
    ...
    lo_cut = zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp_ajson~slice( '/issues' ).
    cl_abap_unit_assert=>assert_equals(
    ...
    lo_cut = zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp_ajson~slice( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
    ...
    lo_cut = zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
    lo_cut ?= lo_cut->zif_mcp_ajson~slice( '/issues/2/start/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->mt_json_tree
      exp = lo_nodes->sorted( ) ).
  ...
  METHOD get_value.
    ...
    DATA lo_cut TYPE REF TO zif_mcp_ajson.
    lo_cut ?= zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  METHOD get_node_type.
    ...
    DATA li_cut TYPE REF TO zif_mcp_ajson.
    li_cut = zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).

    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/' )
      exp = zif_mcp_ajson_types=>node_type-object ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/string' )
      exp = zif_mcp_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/number' )
      exp = zif_mcp_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/float' )
      exp = zif_mcp_ajson_types=>node_type-number ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/boolean' )
      exp = zif_mcp_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/false' )
      exp = zif_mcp_ajson_types=>node_type-boolean ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/null' )
      exp = zif_mcp_ajson_types=>node_type-null ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/date' )
      exp = zif_mcp_ajson_types=>node_type-string ).
    cl_abap_unit_assert=>assert_equals(
      act = li_cut->get_node_type( '/issues' )
      exp = zif_mcp_ajson_types=>node_type-array ).
  ...
  METHOD get_date.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get_date( '/date1' )
      exp = lv_exp ).
  ...
  METHOD get_timestamp.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get_timestamp( '/timestamp' )
      exp = lv_exp ).
  ...
  METHOD array_to_string_table.
    ...
    lt_act = lo_cut->zif_mcp_ajson~array_to_string_table( '/' ).
    cl_abap_unit_assert=>assert_equals(
      act = lt_act
      exp = lt_exp ).
    ...
    TRY.
        lo_cut->zif_mcp_ajson~array_to_string_table( '/x' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_mcp_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
    ...
    TRY.
        lo_cut->zif_mcp_ajson~array_to_string_table( '/' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_mcp_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
    ...
    TRY.
        lo_cut->zif_mcp_ajson~array_to_string_table( '/a' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_mcp_ajson_error INTO lx.
        cl_abap_unit_assert=>assert_equals(
          act = lx->message
  ...
  METHOD get_with_slash_key.
    ...
    CREATE OBJECT lo_nodes.
    lo_nodes->add( '  |         |object |                        | |2' ).
    lo_nodes->add( '/ |my~1key  |str    |value1                  | |0' ).
    lo_nodes->add( '/ |normal   |str    |value2                  | |0' ).
    lo_cut->mt_json_tree = lo_nodes->mt_nodes.

    " Test getting value with escaped key path
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get( '/my~1key' )
      exp = 'value1' ).

    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get( '/normal' )
      exp = 'value2' ).

  ENDMETHOD.

  METHOD exists_with_slash_key.
    ...
    lo_nodes->add( '  |         |object |                        | |2' ).
    lo_nodes->add( '/ |my~1key  |str    |value1                  | |0' ).
    lo_nodes->add( '/ |my~0key  |str    |value2                  | |0' ).
    lo_cut->mt_json_tree = lo_nodes->mt_nodes.

    " Test exists with escaped paths
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~exists( '/my~1key' )
      exp = abap_true ).

    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~exists( '/my~0key' )
      exp = abap_true ).

    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~exists( '/nonexistent' )
      exp = abap_false ).

  ENDMETHOD.

  METHOD members_unescaped.
    ...
    CREATE OBJECT lo_cut.
    CREATE OBJECT lo_nodes.
    lo_nodes->add( '  |         |object |                        | |3' ).
    lo_nodes->add( '/ |my~1key  |str    |value1                  | |0' ).
    lo_nodes->add( '/ |my~0key  |str    |value2                  | |0' ).
    lo_nodes->add( '/ |normal   |str    |value3                  | |0' ).
    lo_cut->mt_json_tree = lo_nodes->mt_nodes.

    " Members should return unescaped names
    APPEND 'my/key' TO lt_exp.
    APPEND 'my~key' TO lt_exp.
    APPEND 'normal' TO lt_exp.

    lt_act = lo_cut->zif_mcp_ajson~members( '/' ).
  ...
  METHOD get_nested_escaped.
    ...
    CREATE OBJECT lo_nodes.
    lo_nodes->add( '           |         |object |                        | |1' ).
    lo_nodes->add( '/          |my~1key  |object |                        | |1' ).
    lo_nodes->add( '/my~1key/  |nested~0 |str    |deep_value              | |0' ).
    lo_cut->mt_json_tree = lo_nodes->mt_nodes.

    " Test nested access with escaped keys
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get( '/my~1key/nested~0' )
      exp = 'deep_value' ).
...
CLASS zcl_mcp_ajson DEFINITION LOCAL FRIENDS ltcl_json_to_abap.
...
CLASS ltcl_json_to_abap IMPLEMENTATION.
  ...
  METHOD to_abap_corresponding_public.
    ...
    DATA ls_act TYPE ty_struc.
    DATA ls_exp  TYPE ty_struc.
    DATA li_json TYPE REF TO zif_mcp_ajson.
    DATA lo_nodes TYPE REF TO lcl_nodes_helper.
  ...
  METHOD to_abap_compressed_stdrd.
    ...
    DATA lo_ajson TYPE REF TO zcl_mcp_ajson.
    DATA lv_json TYPE string.
    ...
    lo_ajson = zcl_mcp_ajson=>parse( lv_json ).
...
CLASS ltcl_writer_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS set_ajson FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS ignore_empty FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_obj FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_obj_w_date_time FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_tab FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_tab_hashed FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_tab_nested_struct FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS prove_path_exists FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS delete_subtree FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS delete FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS arrays FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS arrays_negative FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS root_assignment FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_bool_abap_bool FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_bool_int FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_bool_tab FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_str FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_int FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_number FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_date FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_timestamp FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS read_only FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_array_obj FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_with_type FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS new_array_w_keep_order_touch FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS overwrite_w_keep_order_touch FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS overwrite_w_keep_order_set FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS setx FOR TESTING RAISING zcx_mcp_ajson_error.
    ...
    METHODS set_keys_with_slash FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_keys_with_tilde FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS touch_arr_escaped_key FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS touch_obj_escaped_key FOR TESTING RAISING zcx_mcp_ajson_error.

    METHODS set_with_type_slice
      IMPORTING
        io_json_in  TYPE REF TO zcl_mcp_ajson
        io_json_out TYPE REF TO zif_mcp_ajson
        iv_path     TYPE string
      RAISING
        zcx_mcp_ajson_error.
...
CLASS zcl_mcp_ajson DEFINITION LOCAL FRIENDS ltcl_writer_test.
...
CLASS ltcl_writer_test IMPLEMENTATION.
  ...
  METHOD delete.
    ...
    lo_cut->zif_mcp_ajson~delete( iv_path = '/a/b' ).
  ...
  METHOD set_ajson.
    ...
    DATA lo_nodes TYPE REF TO lcl_nodes_helper.
    DATA lo_src TYPE REF TO zcl_mcp_ajson.
    DATA lo_cut TYPE REF TO zcl_mcp_ajson.
    DATA li_writer TYPE REF TO zif_mcp_ajson.

    lo_src = zcl_mcp_ajson=>create_empty( ).
    lo_cut = zcl_mcp_ajson=>create_empty( ).
    li_writer = lo_cut.
  ...
  METHOD ignore_empty.
    ...
    li_cut = zcl_mcp_ajson=>create_empty( ).
  ...
  METHOD set_obj_w_date_time.
    ...
    lo_cut = zcl_mcp_ajson=>create_empty( )->format_datetime( ).
    li_writer = lo_cut.
  ...
  METHOD set_number.
    ...
    li_json = zcl_mcp_ajson=>create_empty( ).
    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '        |      |object |         ||1' ).
  ...
  METHOD set_with_type.
    ...
    DATA lo_sample TYPE REF TO zcl_mcp_ajson.
    DATA lo_cut TYPE REF TO zcl_mcp_ajson.
    DATA li_writer TYPE REF TO zif_mcp_ajson.

    lo_sample = zcl_mcp_ajson=>parse( ltcl_parser_test=>sample_json( ) ).
  ...
  METHOD setx.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:1' )->stringify( )
      exp = '{"a":1}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:abc' )->stringify( )
      exp = '{"a":"abc"}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:null' )->stringify( )
      exp = '{"a":null}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:true' )->stringify( )
      exp = '{"a":true}' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:false' )->stringify( )
      exp = '{"a":false}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a/b:1' )->stringify( )
      exp = '{"a":{"b":1}}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/:1' )->stringify( )
...
*      exp = '{}' ). " should setx ignore empty values or set an empty string ? Or null ?
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:""' )->stringify( )
      exp = '{"a":""}' ).
  ...
  METHOD setx_float.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:1.123' )->stringify( )
      exp = '{"a":1.123}' ).

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:00.123' )->stringify( )
      exp = '{"a":"00.123"}' ). " not a number

    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:.123' )->stringify( )
      exp = '{"a":".123"}' ).
  ...
  METHOD setx_complex.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = zcl_mcp_ajson=>new( )->setx( '/a:[1, 2]' )->stringify( )
      exp = '{"a":[1,2]}' ).
    ...
    TRY.
        zcl_mcp_ajson=>new( )->setx( '/a:{"b" : 1' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_mcp_ajson_error.
    ENDTRY.

    TRY.
        zcl_mcp_ajson=>new( )->setx( '/a:[1, 2' ).
        cl_abap_unit_assert=>fail( ).
      CATCH zcx_mcp_ajson_error.
    ENDTRY.
  ...
  METHOD setx_complex_w_keep_order.
    ...
    li_cut = zcl_mcp_ajson=>new( iv_keep_item_order = abap_true ).
    li_cut->setx( '/c:3' ).
    li_cut->set(
      iv_path = '/b'
      iv_val  = ls_dummy ).
  ...
  METHOD set_keys_with_slash.
    ...
    " Set values with keys containing slashes
    li_writer->set(
      iv_path = '/my~1key'
      iv_val  = 'value1' ).
    li_writer->set(
  ...
  METHOD set_keys_with_tilde.
    ...
    " Set values with keys containing tildes
    li_writer->set(
      iv_path = '/my~0key'
      iv_val  = 'value1' ).
    li_writer->set(
    ...
    " Verify we can read back the values
    cl_abap_unit_assert=>assert_equals(
      act = lo_cut->zif_mcp_ajson~get( '/my~0key' )
      exp = 'value1' ).

  ENDMETHOD.

  METHOD touch_arr_escaped_key.
    ...
    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '        |      |object |     ||1' ).
    lo_nodes_exp->add( '/       |my~1key|array |     ||1' ).
    lo_nodes_exp->add( '/my~1key/|1     |str   |item1|1|0' ).

    " Touch array with escaped key and add item
    li_writer->touch_array( iv_path = '/my~1key' ).
    li_writer->push(
      iv_path = '/my~1key'
      iv_val  = 'item1' ).
  ...
  METHOD touch_obj_escaped_key.
    ...
    CREATE OBJECT lo_nodes_exp.
    lo_nodes_exp->add( '          |         |object |     ||1' ).
    lo_nodes_exp->add( '/         |my~0key  |object |     ||1' ).
    lo_nodes_exp->add( '/my~0key/ |prop     |str    |val  ||0' ).

    " Touch object with escaped key and add property
    li_writer->touch_object( iv_path = '/my~0key' ).
    li_writer->set(
      iv_path = '/my~0key/prop'
      iv_val  = 'val' ).
...
CLASS ltcl_integrated DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS reader FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_index FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_simple FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS stringify FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS item_order_integrated FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS chaining FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS push_json FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS is_empty FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS json_pointer_roundtrip FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS complex_escaped_struct FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS stringify_escaped_keys FOR TESTING RAISING zcx_mcp_ajson_error.
...
CLASS ltcl_integrated IMPLEMENTATION.
  ...
  METHOD array_simple.
    ...
    DATA li_reader TYPE REF TO zif_mcp_ajson.
    li_reader = zcl_mcp_ajson=>parse( lv_src ).
  ...
  METHOD reader.
    ...
    li_reader = zcl_mcp_ajson=>parse( lv_source ).
  ...
  METHOD stringify.
    ...
    DATA: BEGIN OF ls_data, str TYPE string, cls TYPE REF TO zcl_mcp_ajson, END OF ls_data.
  ...
  METHOD push_json.
    ...
    DATA li_cut TYPE REF TO zif_mcp_ajson.
    DATA li_sub TYPE REF TO zif_mcp_ajson.
    DATA lv_act TYPE string.
    DATA lv_exp TYPE string.

    li_cut = zcl_mcp_ajson=>create_empty( ).
    li_sub = zcl_mcp_ajson=>create_empty( )->set(
      iv_path = 'a'
      iv_val  = '1' ).
    ...
    li_cut->push(
      iv_path = '/list'
      iv_val  = zcl_mcp_ajson=>create_empty( )->set(
        iv_path = 'a'
        iv_val  = '1' ) ).
    li_cut->push(
      iv_path = '/list'
  ...
  METHOD json_pointer_roundtrip.

    DATA lv_input_json TYPE string.
    DATA lv_output_json TYPE string.
    DATA li_json TYPE REF TO zif_mcp_ajson.

    " JSON with keys containing special characters
    lv_input_json = '{"my/key": "value1", "my~key": "value2", "normal": "value3"}'.

    " Parse -> Modify -> Stringify
    li_json = zcl_mcp_ajson=>parse( lv_input_json ).

    " Verify we can read the values
    cl_abap_unit_assert=>assert_equals(
      act = li_json->get( '/my~1key' )
      exp = 'value1' ).
    cl_abap_unit_assert=>assert_equals(
      act = li_json->get( '/my~0key' )
      exp = 'value2' ).

    " Modify a value
    li_json->set(
      iv_path = '/my~1key'
      iv_val  = 'modified_value' ).

    " Add new key with special characters
    li_json->set(
      iv_path = '/new~1~0key'
      iv_val  = 'new_value' ).

    " Stringify and verify output
    lv_output_json = li_json->stringify( ).

    " Should contain the escaped keys properly
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_output_json
      exp = '*"my/key":"modified_value"*' ).
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_output_json
      exp = '*"my~key":"value2"*' ).
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_output_json
      exp = '*"new/~key":"new_value"*' ).

  ENDMETHOD.

  METHOD complex_escaped_struct.

    DATA li_json TYPE REF TO zif_mcp_ajson.
    DATA lv_json TYPE string.

    " Create complex nested structure with escaped keys
    li_json = zcl_mcp_ajson=>create_empty( ).

    li_json->touch_object( '/my~1config' ).
    li_json->set(
      iv_path = '/my~1config/db~1host'
      iv_val  = 'localhost' ).
    li_json->set(
      iv_path = '/my~1config/api~0key'
      iv_val  = 'secret123' ).

    li_json->touch_array( '/my~1config/servers' ).
    li_json->push(
      iv_path = '/my~1config/servers'
      iv_val  = 'server1' ).
    li_json->push(
      iv_path = '/my~1config/servers'
      iv_val  = 'server2' ).
    ...
    cl_abap_unit_assert=>assert_equals(
      act = li_json->get( '/my~1config/db~1host' )
      exp = 'localhost' ).
    cl_abap_unit_assert=>assert_equals(
      act = li_json->get( '/my~1config/api~0key' )
      exp = 'secret123' ).
    cl_abap_unit_assert=>assert_equals(
      act = li_json->get( '/my~1config/servers/1' )
      exp = 'server1' ).

    " Verify members returns unescaped names
    DATA lt_members TYPE string_table.
    DATA lt_exp TYPE string_table.

    lt_members = li_json->members( '/my~1config' ).
    APPEND 'db/host' TO lt_exp.
    APPEND 'api~key' TO lt_exp.
    APPEND 'servers' TO lt_exp.
  ...
  METHOD stringify_escaped_keys.
    ...
    " Add keys that require escaping
    li_json->set(
      iv_path = '/path~1with~1slashes'
      iv_val  = 'value1' ).
    li_json->set(
      iv_path = '/tilde~0key'
      iv_val  = 'value2' ).
    li_json->set(
      iv_path = '/mixed~0~1key'
      iv_val  = 'value3' ).

    lv_json = li_json->stringify( ).

    " Verify JSON output has proper unescaped keys
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_json
      exp = '*"path/with/slashes":"value1"*' ).
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_json
      exp = '*"tilde~key":"value2"*' ).
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_json
      exp = '*"mixed~/key":"value3"*' ).

    " Verify round-trip consistency
    DATA li_reparsed TYPE REF TO zif_mcp_ajson.
    li_reparsed = zcl_mcp_ajson=>parse( lv_json ).

    cl_abap_unit_assert=>assert_equals(
      act = li_reparsed->get( '/path~1with~1slashes' )
      exp = 'value1' ).
    cl_abap_unit_assert=>assert_equals(
      act = li_reparsed->get( '/tilde~0key' )
      exp = 'value2' ).
    cl_abap_unit_assert=>assert_equals(
      act = li_reparsed->get( '/mixed~0~1key' )
      exp = 'value3' ).
...
CLASS ltcl_abap_to_json DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS set_ajson FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_number FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_string FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_true FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_false FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_xsdboolean FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_timestamp FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_value_timestamp_initial FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_null FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_obj FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_array FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_complex_obj FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS set_include_with_suffix FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS prefix FOR TESTING RAISING zcx_mcp_ajson_error.

ENDCLASS.

CLASS zcl_mcp_ajson DEFINITION LOCAL FRIENDS ltcl_abap_to_json.
...
CLASS ltcl_abap_to_json IMPLEMENTATION.
  ...
  METHOD set_ajson.
    ...
    DATA lt_nodes TYPE zif_mcp_ajson_types=>ty_nodes_tt.
  ...
  METHOD prefix.
    ...
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
    DATA lt_nodes TYPE zif_mcp_ajson_types=>ty_nodes_tt.
    DATA ls_prefix TYPE zif_mcp_ajson_types=>ty_path_name.
...
CLASS ltcl_filter_test DEFINITION FINAL
  ...
  PUBLIC SECTION.
    INTERFACES zif_mcp_ajson_filter.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_visit_history,
        path TYPE string,
        type TYPE zif_mcp_ajson_filter=>ty_visit_type,
      END OF ty_visit_history.

    DATA mt_visit_history TYPE TABLE OF ty_visit_history.

    METHODS simple_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS visit_types FOR TESTING RAISING zcx_mcp_ajson_error.
...
CLASS ltcl_filter_test IMPLEMENTATION.
  ...
  METHOD zif_mcp_ajson_filter~keep_node.
  ...
  METHOD simple_test.
    ...
    DATA lo_json TYPE REF TO zcl_mcp_ajson.
    DATA lo_json_filtered TYPE REF TO zcl_mcp_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.

    lo_json = zcl_mcp_ajson=>create_empty( ).
    lo_json->set(
      iv_path = '/a'
      iv_val  = 1 ).
    lo_json->set(
    ...
    lo_json_filtered = zcl_mcp_ajson=>create_from(
  ...
  METHOD visit_types.
    ...
    <v>-path = '/'.
    <v>-type = zif_mcp_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = zif_mcp_ajson_filter=>visit_type-open.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/3/'.
    <v>-type = zif_mcp_ajson_filter=>visit_type-close.
    APPEND INITIAL LINE TO lt_visits_exp ASSIGNING <v>.
    <v>-path = '/'.
    <v>-type = zif_mcp_ajson_filter=>visit_type-close.
...
CLASS ltcl_mapper_test DEFINITION FINAL
  ...
  PUBLIC SECTION.
    INTERFACES zif_mcp_ajson_mapping.

  PRIVATE SECTION.

    METHODS simple_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS array_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS duplication_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS empty_name_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS trivial FOR TESTING RAISING zcx_mcp_ajson_error.

ENDCLASS.

CLASS ltcl_mapper_test IMPLEMENTATION.

  METHOD zif_mcp_ajson_mapping~rename_node.
    IF cv_name+0(1) = 'a'.
  ...
  METHOD zif_mcp_ajson_mapping~to_abap.
  ENDMETHOD.

  METHOD zif_mcp_ajson_mapping~to_json.
  ENDMETHOD.
...
CLASS ltcl_cloning_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS clone_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS filter_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS mapper_test FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS mapper_and_filter FOR TESTING RAISING zcx_mcp_ajson_error.
    METHODS opts_copying FOR TESTING RAISING zcx_mcp_ajson_error.
...
CLASS ltcl_cloning_test IMPLEMENTATION.
  ...
  METHOD clone_test.
    ...
    DATA li_json TYPE REF TO zif_mcp_ajson.
    DATA li_json_new TYPE REF TO zif_mcp_ajson.
    DATA lo_nodes_exp TYPE REF TO lcl_nodes_helper.
  ...
  METHOD mapper_and_filter.
    ...
    li_json_new = zcl_mcp_ajson=>create_from(
  ...
  METHOD opts_copying.
    ...
    li_json = zcl_mcp_ajson=>new( )->keep_item_order( ).
    li_json->set(
      iv_path = '/ab'
      iv_val  = 1 ).
