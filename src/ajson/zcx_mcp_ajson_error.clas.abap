class ZCX_MCP_AJSON_ERROR definition
  public
...
CLASS ZCX_MCP_AJSON_ERROR IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_mcp_AJSON_ERROR .
else.
