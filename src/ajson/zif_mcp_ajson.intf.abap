interface zif_mcp_ajson
  ...
  data mt_json_tree type zif_mcp_ajson_types=>ty_nodes_ts read-only.
  ...
  methods get_node_type
    importing
      iv_path type string
    returning
      value(rv_node_type) type zif_mcp_ajson_types=>ty_node_type.
  ...
  methods set
    importing
      ...
      iv_node_type type zif_mcp_ajson_types=>ty_node_type optional
    returning
      value(ri_json) type ref to zif_mcp_ajson
    raising
      zcx_mcp_ajson_error.
