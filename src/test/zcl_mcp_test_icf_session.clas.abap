...
CLASS zcl_mcp_test_icf_session IMPLEMENTATION.
  METHOD handle_initialize.
    ...
    CLEAR temp1.
    temp1-name = `Simple Test Server to check ICF sessions`.
    temp1-version = `1.0`.
  ...
  METHOD handle_list_tools.
    ...
    TRY.
        ...
        temp4-name = `Test ICF Session`.
        temp4-description = `Using ICF sessions we increment by the given number`.
